...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_ABOUT:
			...
			break;
		case IDM_OPEN_FILE:
			MessageBox(NULL, L"Open Torrent File", L"Popup", MB_OK);
			break;
		case IDM_OPEN_LINK:
			MessageBox(NULL, L"Open Magnet Link", L"Popup", MB_OK);
			break;
		case IDM_EXIT:
			if (MessageBox(NULL, L"Are you sure you want to quit?", L"Confirmation", MB_YESNO) == IDYES)
			{
				DestroyWindow(hWnd);
			}
